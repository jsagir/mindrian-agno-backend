...
_BOT_HINT_PREFIX: Dict[str, str] = {
    "larry": "[GraphRAG context for larry - ",
    "tta": "[GraphRAG context for tta - ",
    "jtbd": "[GraphRAG context for jtbd - ",
    "scurve": "[GraphRAG context for scurve - ",
    "redteam": "[GraphRAG context for redteam - ",
}

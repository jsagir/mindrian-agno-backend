...
const SidebarHeader = () => (
  <div className="flex items-center justify-between w-full">
    <div className="flex items-center gap-2">
      <div className="h-6 w-6 rounded-md mindrian-gradient flex items-center justify-center">
        <span className="text-xs font-bold text-white">M</span>
      </div>
      <span className="text-xs font-medium uppercase text-white">Mindrian</span>
    </div>
    <SettingsModal />
  </div>
)
...
const Endpoint = () => {
  ...
  return (
    <div className="flex flex-col items-start gap-2">
      <div className="text-xs font-medium uppercase text-primary">Mindrian OS</div>
      {isEditing ? (
